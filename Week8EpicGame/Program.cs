...
string[] weapon = { "magic wond", "plastic fork", "banana", "wooden sword", "Lego brick" };
...
static string GetRandomValueFromArray(string[] someArrey)
{
    Random rnd = new Random();
    int randomIndex = rnd.Next(0, someArrey.Length);
    string randomStringFromArray = someArrey[randomIndex];
